                    ...
                    <?php if(trim($__env->yieldContent('page-title'))): ?>
                        <div class="col-xl-5 col-lg-4 col-md-12 d-flex align-items-center justify-content-between justify-content-md-start">
                            <div class="d-inline-block">
                                <h5 class="d-inline-block mb-0"><?php echo $__env->yieldContent('page-title'); ?></h5>
                            </div>
                        </div>
                    <?php endif; ?>
...
<?php /**PATH /Users/kevindupas/Documents/GitHub/support-ticket/resources/views/layouts/admin.blade.php ENDPATH**/ ?>
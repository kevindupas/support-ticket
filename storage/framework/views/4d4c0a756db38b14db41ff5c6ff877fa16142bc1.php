<?php if($customFields): ?>
    <?php $__currentLoopData = $customFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customField): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php if($customField->id == '1'): ?>
            <div class="form-group col-md-<?php echo e($customField->width); ?>">
                <label for="name" class="form-control-label"><?php echo e(__($customField->name)); ?></label>
        ...
        <?php elseif($customField->id == '2'): ?>
            <div class="form-group col-md-<?php echo e($customField->width); ?>">
                <label for="email" class="form-control-label"><?php echo e(__($customField->name)); ?></label>
                <div class="form-icon-user">
        ...
        <?php elseif($customField->id == '3'): ?>
            <div class="form-group col-md-<?php echo e($customField->width); ?>">
                <label for="category" class="form-control-label"><?php echo e(__($customField->name)); ?></label>
                <select class="select2 select2" id="category" name="category" data-placeholder="<?php echo e(__($customField->placeholder)); ?>">
        ...
        <?php elseif($customField->id == '4'): ?>
            <div class="form-group col-md-<?php echo e($customField->width); ?>">
                <label for="subject" class="form-control-label"><?php echo e(__($customField->name)); ?></label>
                <div class="form-icon-user">
        ...
        <?php elseif($customField->id == '6'): ?>
            <div class="form-group col-md-<?php echo e($customField->width); ?>">
                <label class="form-control-label"><?php echo e(__($customField->name)); ?> <small>(<?php echo e(__($customField->placeholder)); ?>)</small></label>
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php endif; ?>
<?php /**PATH /Users/kevindupas/Documents/GitHub/support-ticket/resources/views/admin/customFields/formBuilder.blade.php ENDPATH**/ ?>